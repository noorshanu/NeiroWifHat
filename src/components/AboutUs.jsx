...
<br />
              ...
              <div className=" bg-white border-4 box-s2 rounded-2xl border-black py-8 max-w-sm mx-auto px-2">
                ...
                Leading the Neiro Army like an absolute boss: Bulls? Bears? HA! It’s all about memes and fueled by Lambo dreams, bro! The grind? Simple—laugh our way straight to the moon, in pure alpha style. VROOOOOM! 🏎️💨
                </p>
              </div>
            </div>
          </div>
